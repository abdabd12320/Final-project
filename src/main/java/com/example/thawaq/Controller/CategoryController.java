...
public class CategoryController {
    ...
    public ResponseEntity applyDiscountToCategoryByName(@PathVariable String categoryName, @PathVariable Integer branchId, @AuthenticationPrincipal User user, @PathVariable double discountPercentage){
        categoryService.applyDiscountToCategoryByName(categoryName,branchId, user.getId(), discountPercentage);
